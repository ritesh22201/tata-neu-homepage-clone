            ...
            <Flex gap={'10px'} mt={'40px'} w={'100%'} flexDir={{base : 'column', sm : 'column', md : 'column', lg : 'row', xl : 'row', '2xl' : 'row'}} justifyContent={'space-between'}>
                ...
                <Box h={'fit-content'} className='box' w={{base : '100%', sm : '100%', md : '100%', lg : '55%', xl : '55%', '2xl' : '55%'}} p={'20px 30px'} bg={'#FCF8FF'} borderRadius={'10px'}>
                    ...
                    <Box>
                        ...
                        <Text ml={'5.4%'} color={'gray.500'}>Can go up to <span style={{color: 'var(--1, #8800EC)', fontWeight : 'bold'}}>Rs 40 lakh:</span> some lenders may offer higher loan amount</Text>
                    </Box>
                    <Box>
                        <Flex alignItems={'center'} gap={'7px'}>
                            <Image src={star2}/>
                        ...
                        <Text ml={'5.4%'} color={'gray.500'}><span style={{color: 'var(--1, #8800EC)', fontWeight : 'bold'}}>0.5% to 4%</span> of loan amount (may vary across lenders)</Text>
                    </Box>
                    <Box>
                        <Flex alignItems={'center'} gap={'7px'}>
                            <Image src={star2}/>
                        ...
                        <Text ml={'5.4%'} color={'gray.500'}>Up to <span style={{color: 'var(--1, #8800EC)', fontWeight : 'bold'}}>5 years</span> (some lenders offer repayment period till 8 year)</Text>
                    </Box>
                </Box>
            </Flex>
        </Box>
